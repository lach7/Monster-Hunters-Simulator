game.ServerScriptService.DB_Beam.Event:Connect(function(Mouse, Tool)
	...
	if Distance < 35 then
		EndPoint.Position = Mouse + Vector3.new(math.random(0, 2), math.random(0, 1),math.random(0, 2))
		
	else
		EndPoint.Position = Mouse + Vector3.new(math.random(2, 4), math.random(2, 2),math.random(2, 5))
	end
